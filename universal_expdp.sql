...
set /p TABLES="Enter Table(s) to Export (comma-separated or leave blank for all): " 
...
IF "%TABLES%"=="ALL" (
    ...
    expdp system/password@%ORACLE_SID% SCHEMAS=%SCHEMA% TABLES=%TABLES% DIRECTORY=%DIRECTORY% DUMPFILE=%DUMPFILE% LOGFILE=%LOGFILE% FILESIZE=%FILESIZE% PARALLEL=%PARALLEL% COMPRESSION=%COMPRESSION% VERSION=%EXPORT_VERSION%
)
